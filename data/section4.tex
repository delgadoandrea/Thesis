...
\subsection{L1 Trigger and HLT}
 Whenever the LHC is performing at its peak, about one billion proton-proton interactions take place every second inside the CMS detector. The triggers system allows to record only a fraction of those events, hoping they are generated from energetic, head-on collisions.
